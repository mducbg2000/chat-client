...
/**
 * 
 * @param {string} inputKey length 256
 * @param {number} outputKeyLenInBits HKDF throws if this/256 > 255
 * @param {string | bitarray} salt string or bitarray of length 256
 * @param {string | bitarray} infoStr 
 * @returns 
 */
