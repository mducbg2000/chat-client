...
function ba(a, b, d) {
  ...
  for (n = 0; n < m; n++)
    (h =
      a[e >>> 24] ^ t[(f >> 16) & 255] ^ I[(g >> 8) & 255] ^ H[b & 255] ^ c[p]),
      (k =
        a[f >>> 24] ^
        t[(g >> 16) & 255] ^
        I[(b >> 8) & 255] ^
...
sjcl.bitArray = {
  ...
  concat: function (a, b) {
    ...
    return 32 === c
      ? a.concat(b)
      : sjcl.bitArray.ra(b, c, d | 0, a.slice(0, a.length - 1));
  },
  ...
  clamp: function (a, b) {
    ...
    0 < d &&
      b &&
      (a[d - 1] = sjcl.bitArray.partial(
        b,
        a[d - 1] & (2147483648 >> (b - 1)),
        1
      ));
    return a;
  },
  ...
  byteswapM: function (a) {
    ...
    for (b = 0; b < a.length; ++b)
      (d = a[b]),
        (a[b] =
          (d >>> 24) | ((d >>> 8) & 0xff00) | ((d & 0xff00) << 8) | (d << 24));
    return a;
  },
};
...
sjcl.codec.base32 = {
  ...
  fromBits: function (a, b, d) {
    ...
    for (d = 0; f.length * c < l; )
      (f += h.charAt((k ^ (a[d] >>> g)) >>> e)),
        g < c ? ((k = a[d] << (c - g)), (g += e), d++) : ((k <<= c), (g -= c));
    for (; f.length & 7 && !b; ) f += "=";
    return f;
  },
  toBits: function (a, b) {
...
sjcl.codec.z85 = {
  ...
  fromBits: function (a) {
    if (!a) return null;
    if (0 !== sjcl.bitArray.bitLength(a) % 32)
  ...
  toBits: function (a) {
    ...
    for (
      var b = [], d = 0, c = sjcl.codec.z85.ya, e = 0, f = 0, g = 0;
      g < a.length;

    )
      if (((d = 85 * d + c[a[g++].charCodeAt(0) - 32]), 0 === g % 5)) {
        for (var h = 0x1000000; h; )
          (e = e * Math.pow(2, 8) + (Math.floor(d / h) % 0x100)),
            ++f,
            4 === f && (b.push(e), (f = e = 0)),
...
sjcl.hash.sha256 = function (a) {
  this.i[0] || this.T();
  a
    ? ((this.c = a.c.slice(0)), (this.h = a.h.slice(0)), (this.f = a.f))
    : this.reset();
};
...
sjcl.hash.sha256.prototype = {
  ...
  T: function () {
    ...
    for (var b = 0, d = 2, c, e; 64 > b; d++) {
      ...
      e &&
        (8 > b && (this.A[b] = a(Math.pow(d, 0.5))),
        (this.i[b] = a(Math.pow(d, 1 / 3))),
        b++);
    }
  },
  m: function (a) {
...
sjcl.hash.sha512.prototype = {
  ...
  A: [],
  Fa: [
    12372232, 13281083, 9762859, 1914609, 15106769, 4090911, 4308331, 8266105,
  ],
  i: [],
  Ha: [
    2666018, 15689165, 5061423, 9034684, 4764984, 380953, 1658779, 7176472,
    197186, 7368638, 14987916, 16757986, 8096111, 1480369, 13046325, 6891156,
    15813330, 5187043, 9229749, 11312229, 2818677, 10937475, 4324308, 1135541,
    6741931, 11809296, 16458047, 15666916, 11046850, 698149, 229999, 945776,
    13774844, 2541862, 12856045, 9810911, 11494366, 7844520, 15576806, 8533307,
    15795044, 4337665, 16291729, 5553712, 15684120, 6662416, 7413802, 12308920,
    13816008, 4303699, 9366425, 10176680, 13195875, 4295371, 6546291, 11712675,
    15708924, 1519456, 15772530, 6568428, 6495784, 8568297, 13007125, 7492395,
    2515356, 12632583, 14740254, 7262584, 1535930, 13146278, 16321966, 1853211,
    294276, 13051027, 13221564, 1051980, 4080310, 6651434, 14088940, 4675607,
  ],
  T: function () {
    function a(a) {
      return (0x100000000 * (a - Math.floor(a))) | 0;
    ...
    for (var d = 0, c = 2, e, f; 80 > d; c++) {
      ...
      f &&
        (8 > d &&
          ((this.A[2 * d] = a(Math.pow(c, 0.5))),
          (this.A[2 * d + 1] = (b(Math.pow(c, 0.5)) << 24) | this.Fa[d])),
        (this.i[2 * d] = a(Math.pow(c, 1 / 3))),
        (this.i[2 * d + 1] = (b(Math.pow(c, 1 / 3)) << 24) | this.Ha[d]),
        d++);
    }
  },
  m: function (a) {
...
sjcl.mode.ccm = {
    ...
    if (b.length)
      for (
        d = h.bitLength(b) / 8,
          65279 >= d
            ? (g = [h.partial(16, d)])
            : 0xffffffff >= d && (g = h.concat([h.partial(16, 65534)], [d])),
          g = h.concat(g, b),
          b = 0;
        b < g.length;
        b += 4
  ...
  R: function (a, b, d, c, e, f) {
    ...
    if (0xffffffff < c.length || 0xffffffff < b.length)
  ...
  u: function (a, b, d, c, e, f) {
    ...
    var k = b.length,
      ...
      n = m;
    d = h
      .concat([h.partial(8, f - 1)], d)
      .concat([0, 0, 0])
      .slice(0, 4);
    c = h.bitSlice(g(c, a.encrypt(d)), 0, e);
    if (!k) return { tag: c, data: [] };
    for (g = 0; g < k; g += 4)
      g > m && (sjcl.mode.ccm.ha(g / k), (m += n)),
        d[3]++,
        (e = a.encrypt(d)),
        (b[g] ^= e[0]),
        (b[g + 1] ^= e[1]),
        (b[g + 2] ^= e[2]),
        (b[g + 3] ^= e[3]);
    return { tag: c, data: h.clamp(b, l) };
  },
};
void 0 === sjcl.beware && (sjcl.beware = {});
sjcl.beware[
  "CTR mode is dangerous because it doesn't protect message integrity."
] = function () {
  sjcl.mode.ctr = {
    name: "ctr",
    ...
    ga: function (a, b, d, c) {
      ...
      if (128 !== sjcl.bitArray.bitLength(d))
...
sjcl.mode.ocb2 = {
  ...
  encrypt: function (a, b, d, c, e, f) {
    ...
    for (g = 0; g + 4 < b.length; g += 4)
      (n = b.slice(g, g + 4)),
        (m = l(m, n)),
        (p = p.concat(l(d, a.encrypt(l(d, n))))),
        (d = h(d));
    n = b.slice(g);
    b = k.bitLength(n);
  ...
  decrypt: function (a, b, d, c, e, f) {
    ...
    for (d = 0; d + 4 < r / 32; d += 4)
      (n = k(m, a.decrypt(k(m, b.slice(d, d + 4))))),
        (l = k(l, n)),
        (t = t.concat(n)),
        (m = g(m));
    p = r - 32 * d;
  ...
  pmac: function (a, b) {
    ...
    d = b.slice(d);
    128 > e.bitLength(d) &&
      ((h = f(h, c(h))), (d = e.concat(d, [-2147483648, 0, 0, 0])));
    g = f(g, d);
    ...
    return {
      process: function (b) {
        ...
        for (f = 0; f + 4 < r.length; f += 4)
          (n = r.slice(f, f + 4)),
            (l = k(l, n)),
            (d = d.concat(k(m, a.encrypt(k(m, n))))),
            (m = g(m));
        r = r.slice(f);
        return d;
      },
    ...
    return {
      process: function (b) {
        ...
        for (f = 0; f + 4 < (b - c) / 32; f += 4)
          (n = k(m, a.decrypt(k(m, r.slice(f, f + 4))))),
            (l = k(l, n)),
            (d = d.concat(n)),
            (m = g(m));
        r = r.slice(f);
      ...
      finalize: function () {
        ...
        l = a.encrypt(k(l, k(m, g(m))));
        d.length && (l = k(l, e ? d : sjcl.mode.ocb2.pmac(a, d)));
        if (!h.equal(h.clamp(l, c), h.bitSlice(r, p)))
          throw new sjcl.exception.corrupt("ocb: tag doesn't match");
        return h.clamp(n, p);
      },
    };
...
sjcl.mode.gcm = {
  ...
  Da: function (a, b) {
    ...
    f = b.slice(0);
    for (d = 0; 128 > d; d++) {
      (c = 0 !== (a[Math.floor(d / 32)] & (1 << (31 - (d % 32))))) &&
        (e = h(e, f));
      g = 0 !== (f[3] & 1);
  ...
  J: function (a, b, d) {
    ...
    for (c = 0; c < e; c += 4)
      (b[0] ^= 0xffffffff & d[c]),
        (b[1] ^= 0xffffffff & d[c + 1]),
        (b[2] ^= 0xffffffff & d[c + 2]),
        (b[3] ^= 0xffffffff & d[c + 3]),
        (b = sjcl.mode.gcm.Da(b, a));
    return b;
  },
  u: function (a, b, d, c, e, f) {
    var g,
    ...
    c[2] ^= k[2];
    c[3] ^= k[3];
    return { tag: t.bitSlice(c, 0, f), data: d };
  },
};
...
sjcl.misc.hkdf = function (a, b, d, c, e) {
  ...
  for (e = 1; e <= a; e++)
    d.update(f),
      d.update(c),
      d.update([sjcl.bitArray.partial(8, e)]),
      (f = d.digest()),
      (g = sjcl.bitArray.concat(g, f));
...
sjcl.misc.scrypt = function (a, b, d, c, e, f, g) {
  ...
  c = c || 8;
  e = e || 1;
  if (c * e >= Math.pow(2, 30))
    throw sjcl.exception.invalid(
...
sjcl.misc.scrypt.blockMix = function (a) {
  for (
    ...
    e.blockxor(a, 16 * f, b, 0, 16),
      e.salsa20Core(b, 8),
      0 == (f & 1)
        ? e.blockcopy(b, 0, d, 8 * f)
        : e.blockcopy(b, 0, d, 8 * (f ^ (1 + c)));
  return d;
};
...
sjcl.prng.prototype = {
  randomWords: function (a, b) {
    ...
    if (c & this.Z) {
      ...
      for (
        g = 0;
        g < this.s.length &&
        ((e = e.concat(this.s[g].finalize())),
        (f += this.K[g]),
        (this.K[g] = 0),
        c || !(this.da & (1 << g)));
        g++
      );
      this.da >= 1 << this.s.length &&
        (this.s.push(new sjcl.hash.sha256()), this.K.push(0));
      this.B -= f;
      f > this.L && (this.L = f);
      this.da++;
      ...
      for (
        c = 0;
        4 > c && ((this.F[c] = (this.F[c] + 1) | 0), !this.F[c]);
        c++
      );
    }
    for (c = 0; c < a; c += 4)
      0 === (c + 1) % this.va && ca(this),
        (e = da(this)),
  ...
  addEntropy: function (a, b, d) {
    ...
    this.B += b;
    h === this.O &&
      (this.isReady() !== this.O && ea("seeded", Math.max(this.L, this.B)),
      ea("progress", this.getProgress()));
  },
  isReady: function (a) {
    a = this.fa[void 0 !== a ? a : this.ba];
    return this.L && this.L >= a
      ? this.K[0] > this.ua && new Date().valueOf() > this.qa
        ? this.Z | this.Y
        : this.Y
      : this.B >= a
      ? this.Z | this.O
  ...
  startCollectors: function () {
    if (!this.V) {
      ...
      if (window.addEventListener)
        window.addEventListener("load", this.j.loadTimeCollector, !1),
          window.addEventListener("mousemove", this.j.mouseCollector, !1),
          window.addEventListener("keypress", this.j.keyboardCollector, !1),
          window.addEventListener(
            "devicemotion",
            this.j.accelerometerCollector,
            !1
          ),
          window.addEventListener("touchmove", this.j.touchCollector, !1);
      else if (document.attachEvent)
        document.attachEvent("onload", this.j.loadTimeCollector),
  ...
  stopCollectors: function () {
    this.V &&
      (window.removeEventListener
        ? (window.removeEventListener("load", this.j.loadTimeCollector, !1),
          window.removeEventListener("mousemove", this.j.mouseCollector, !1),
          window.removeEventListener("keypress", this.j.keyboardCollector, !1),
          window.removeEventListener(
            "devicemotion",
            this.j.accelerometerCollector,
            !1
          ),
          window.removeEventListener("touchmove", this.j.touchCollector, !1))
        : document.detachEvent &&
          (document.detachEvent("onload", this.j.loadTimeCollector),
...
a: try {
  ...
  if (ia && fa.randomBytes)
    (S = fa.randomBytes(128)),
      (S = new Uint32Array(new Uint8Array(S).buffer)),
      sjcl.random.addEntropy(S, 1024, "crypto['randomBytes']");
  else if (
    "undefined" !== typeof window &&
  ...
  Ca: function (a, b, d, c) {
    ...
    f.ct =
      ...
      b instanceof ArrayBuffer
        ? sjcl.arrayBuffer.ccm.encrypt(g, b, f.iv, d, f.ts)
        : sjcl.mode[f.mode].encrypt(g, b, f.iv, d, f.ts);
    return f;
  },
  encrypt: function (a, b, d, c) {
    var e = sjcl.json,
  ...
  decode: function (a) {
    ...
    for (d = 0; d < a.length; d++) {
      if (
        ...
        throw new sjcl.exception.invalid("json decode: this isn't json!");
      null != c[3]
        ? (b[c[2]] = parseInt(c[3], 10))
        : null != c[4]
        ? (b[c[2]] = c[2].match(/^(ct|adata|salt|iv)$/)
            ? sjcl.codec.base64.toBits(c[4])
            : unescape(c[4]))
        : null != c[5] && (b[c[2]] = "true" === c[5]);
    }
    return b;
  },
  C: function (a, b, d) {
...
sjcl.misc.cachedPbkdf2 = function (a, b) {
  ...
  return { key: c[d].slice(0), salt: d.slice(0) };
};
sjcl.bn = function (a) {
  this.initWith(a);
};
sjcl.bn.prototype = {
    ...
    switch (typeof a) {
      ...
      case "string":
        ...
        for (b = 0; b < a.length; b += d)
          this.limbs.push(
            parseInt(
              a.substring(Math.max(a.length - b - d, 0), a.length - b),
              16
            )
          );
        break;
  ...
  inverseMod: function (a) {
    ...
    do
      for (
        c.limbs[0] & 1 &&
          (c.greaterEquals(e) ||
            ((f = c), (c = e), (e = f), (f = b), (b = d), (d = f)),
          c.subM(e),
          c.normalize(),
          b.greaterEquals(d) || b.addM(a),
          b.subM(d)),
          c.halveM(),
  ...
  powermod: function (a, b) {
    ...
    for (
      var c, e = a.normalize().trim().limbs, f = new this.o(1), g = this, d = 0;
      d < e.length;
      d++
    )
  ...
  montpowermod: function (a, b) {
    ...
    function c(a, d) {
      ...
      for (c = 0; c < e.limbs.length; c++)
        0 < c && (e.limbs[c - 1] |= (e.limbs[c] & f) << (g - l - 1)),
          (e.limbs[c] >>= l + 1);
  ...
  toBits: function (a) {
    ...
    var b = Math.floor((a - 1) / 24),
      d = sjcl.bitArray,
      c = [
        d.partial(((a + 7) & -8) % this.radix || this.radix, this.getLimb(b)),
      ];
    for (b--; 0 <= b; b--)
      (c = d.concat(c, [d.partial(Math.min(this.radix, a), this.getLimb(b))])),
        (a -= this.radix);
    return c;
  },
  bitLength: function () {
...
sjcl.bn.pseudoMersennePrime = function (a, b) {
  ...
  for (e = 0; e < b.length; e++)
    (c.offset[e] = Math.floor(b[e][0] / c.radix - f)),
      (c.fullOffset[e] = Math.ceil(b[e][0] / c.radix - f)),
      (c.factor[e] =
        b[e][1] * Math.pow(0.5, a - b[e][0] + c.offset[e] * c.radix)),
      (c.fullFactor[e] =
        b[e][1] * Math.pow(0.5, a - b[e][0] + c.fullOffset[e] * c.radix)),
      c.modulus.addM(new sjcl.bn(Math.pow(2, b[e][0]) * b[e][1])),
      (c.minOffset = Math.min(c.minOffset, -c.offset[e]));
  c.o = d;
...
sjcl.bn.random = function (a, b) {
  ...
  for (
    var d, c, e = a.limbs.length, f = a.limbs[e - 1] + 1, g = new sjcl.bn();
    ;

  ) {
    do
      (d = sjcl.random.randomWords(e, b)),
        0 > d[e - 1] && (d[e - 1] += 0x100000000);
...
sjcl.ecc.point = function (a, b, d) {
  void 0 === b
    ...
    : (b instanceof sjcl.bn && (b = new a.field(b)),
      d instanceof sjcl.bn && (d = new a.field(d)),
      (this.x = b),
      (this.y = d),
      (this.isIdentity = !1));
  this.curve = a;
...
sjcl.ecc.point.prototype = {
  ...
  multiples: function () {
    ...
    if (void 0 === this.pa)
      for (
        d = this.toJac().doubl(),
          a = this.pa = [new sjcl.ecc.point(this.curve), this, d.toAffine()],
          b = 3;
        16 > b;
        b++
      )
...
sjcl.ecc.pointJac = function (a, b, d, c) {
  void 0 === b
    ? (this.isIdentity = !0)
    : ((this.x = b), (this.y = d), (this.z = c), (this.isIdentity = !1));
  this.curve = a;
};
sjcl.ecc.pointJac.prototype = {
  ...
  mult2: function (a, b, d, c) {
    ...
    "number" === typeof d
      ? (d = [d])
      : void 0 !== d.limbs && (d = d.normalize().limbs);
    var e,
    ...
    for (c = Math.max(a.length, d.length) - 1; 0 <= c; c--)
      for (
        h = a[c] | 0, k = d[c] | 0, e = sjcl.bn.prototype.radix - 4;
        0 <= e;
        e -= 4
      )
        f = f
...
sjcl.ecc.curve.prototype.fromBits = function (a) {
  ...
  a = new sjcl.ecc.point(
    this,
    this.field.fromBits(b.bitSlice(a, 0, d)),
    this.field.fromBits(b.bitSlice(a, d, 2 * d))
  );
...
sjcl.ecc.elGamal.publicKey.prototype = {
  kem: function (a) {
    ...
    return { key: sjcl.hash.sha256.hash(this.H.mult(a).toBits()), tag: b };
  },
  getType: function () {
    return "elGamal";
  },
...
sjcl.keyexchange.srp = {
  ...
  Ea: function () {
    ...
    for (a = 0; a < sjcl.keyexchange.srp.ma.length; a++)
      (b = sjcl.keyexchange.srp.ma[a].toString()),
        (b = sjcl.keyexchange.srp.na[b]),
        (b.N = new sjcl.bn(b.N)),
        (b.g = new sjcl.bn(b.g));
...
sjcl.arrayBuffer.ccm = {
  ...
  encrypt: function (a, b, d, c, e, f) {
    ...
    return { ciphertext_buffer: b, tag: c };
  },
  ...
  u: function (a, b, d, c, e, f) {
    ...
    0 === d[3] && d[2]++;
    if (0 !== b.byteLength)
      for (e = new DataView(b), m = 0; m < e.byteLength; m += 16)
        m > n && (sjcl.mode.ccm.ha(m / b.byteLength), (n += p)),
          (l = a.encrypt(d)),
          (g = e.getUint32(m)),
          (h = e.getUint32(m + 4)),
          (f = e.getUint32(m + 8)),
          (k = e.getUint32(m + 12)),
          e.setUint32(m, g ^ l[0]),
          e.setUint32(m + 4, h ^ l[1]),
          e.setUint32(m + 8, f ^ l[2]),
          e.setUint32(m + 12, k ^ l[3]),
          d[3]++,
          0 === d[3] && d[2]++;
    return c;
  },
...
sjcl.codec.arrayBuffer = {
  fromBits: function (a, b, d) {
    ...
    if (0 !== sjcl.bitArray.bitLength(a) % 8)
      throw new sjcl.exception.invalid(
  ...
  Oa: function (a) {
    ...
    for (var d = "", c = 0; c < a.byteLength; c += 2)
      0 == c % 16 && (d += "\n" + c.toString(16) + "\t"),
        (d += b(a.getUint16(c).toString(16)) + " ");
    void 0 === typeof console && (console = console || { log: function () {} });
...
(function () {
  ...
  function d(b) {
    for (
      ...
      (w = a(d + (c ^ g ^ h) + b[k[q]] + e[q], m[q]) + x),
        (d = x),
        (x = h),
        (h = a(g, 10)),
        (g = c),
        (c = w),
        (w = a(B + (A ^ (y | ~u)) + b[l[q]] + f[q], n[q]) + v),
        (B = v),
        (v = u),
        (u = a(y, 10)),
        (y = A),
        (A = w);
    for (; 32 > q; ++q)
      (w = a(d + ((c & g) | (~c & h)) + b[k[q]] + e[q], m[q]) + x),
        (d = x),
        (x = h),
        (h = a(g, 10)),
        (g = c),
        (c = w),
        (w = a(B + ((A & u) | (y & ~u)) + b[l[q]] + f[q], n[q]) + v),
        (B = v),
        (v = u),
        (u = a(y, 10)),
        (y = A),
    ...
    for (; 48 > q; ++q)
      (w = a(d + ((c | ~g) ^ h) + b[k[q]] + e[q], m[q]) + x),
        ...
        (A = w);
    for (; 64 > q; ++q)
      (w = a(d + ((c & h) | (g & ~h)) + b[k[q]] + e[q], m[q]) + x),
        (d = x),
        (x = h),
        (h = a(g, 10)),
        (g = c),
        (c = w),
        (w = a(B + ((A & y) | (~A & u)) + b[l[q]] + f[q], n[q]) + v),
        (B = v),
        (v = u),
        (u = a(y, 10)),
        (y = A),
  ...
  sjcl.hash.ripemd160.prototype = {
    ...
    finalize: function () {
      var a = sjcl.bitArray.concat(this.h, [sjcl.bitArray.partial(1, 1)]),
        ...
        e = c % 32;
      for (
        0 < e && (a = sjcl.bitArray.concat(a, [sjcl.bitArray.partial(e, 0)]));
        32 <= c;
        c -= 32
      )
        a.push(0);
  ...
  for (
    var c = [1732584193, 4023233417, 2562383102, 271733878, 3285377520],
      e = [0, 1518500249, 1859775393, 2400959708, 2840853838],
